      ...
      <div className="w-full max-w-md rounded-xl border bg-white p-8 shadow-sm">
        <div className="mb-8">
          <img
            ...
            className="mx-auto mb-4 h-24 w-24 object-contain brightness-0"
          />
          <h1 className="text-2xl font-bold text-[var(--kubix-navy)]">Kubix UTN 2.0</h1>
          <p className="mt-1 text-sm text-slate-500">Comunidad UTN: tu ruta, tus amigos</p>
        </div>
